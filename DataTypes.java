public class DataTypes {
    public static void byteTest(Byte b) {
        System.out.println("- The bytes is " + b);
        System.out.println(" Range: " + Byte.MIN_VALUE +
                " => " + Byte.MAX_VALUE + " (" + Short.BYTES + " bytes)");
    }
    ...
    public static void longTest(Long l) {
        System.out.println("-The lonf is " + l);
    ...
    public static void doubleTest(Double l) {
        System.out.println("-The double is " + l);
